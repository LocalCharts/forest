...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var u3 = (o11, l8, t5 = o11) => (o11._$AI(l8, t5), o11);
  var f2 = {};
  var s5 = (o11, l8 = f2) => o11._$AH = l8;
  var m2 = (o11) => o11._$AH;
  var p2 = (o11) => {
    var l8;
...
`;
  ...
  var SETTINGS_SCHEMA = {
    ...
    maxExpand: {
      ...
      processor: (n9) => Math.max(0, n9),
      cli: "-e, --max-expand <n>",
      cliProcessor: (n9) => n9 === "Infinity" ? Infinity : parseInt(n9)
    },
    globalGroup: {
      type: "boolean",
      cli: false
  ...
  var allBlocks = [];
  scriptData.forEach((s7) => s7.blocks.forEach((b2) => allBlocks.push(...b2)));
  ...
  defineFunction({
    ...
    handler(_ref, args) {
      ...
      if (isNaN(code3)) {
        ...
        text2 = String.fromCharCode(code3);
      } else {
        code3 -= 65536;
        text2 = String.fromCharCode((code3 >> 10) + 55296, (code3 & 1023) + 56320);
      }
      return {
        type: "textord",
        mode: parser.mode,
  ...
  var Parser = class _Parser {
    ...
    formLigatures(group) {
      ...
      for (var i5 = 0; i5 < n9; ++i5) {
        var a3 = group[i5];
        var v2 = a3.text;
        if (v2 === "-" && group[i5 + 1].text === "-") {
          if (i5 + 1 < n9 && group[i5 + 2].text === "-") {
            group.splice(i5, 3, {
              type: "textord",
              mode: "text",
  ...
  var splitAtDelimiters = function splitAtDelimiters2(text2, delimiters2) {
    ...
    while (true) {
      ...
      var i5 = delimiters2.findIndex((delim) => text2.startsWith(delim.left));
      index = findEndOfMath(delimiters2[i5].right, text2, delimiters2[i5].left.length);
      if (index === -1) {
        break;
      }
      var rawData = text2.slice(0, index + delimiters2[i5].right.length);
      var math2 = amsRegex.test(rawData) ? rawData : text2.slice(delimiters2[i5].left.length, index);
      data.push({
        type: "math",
        data: math2,
        rawData,
        display: delimiters2[i5].display
      });
      text2 = text2.slice(index + delimiters2[i5].right.length);
    }
    if (text2 !== "") {
      data.push({
        type: "text",
    ...
    for (var i5 = 0; i5 < data.length; i5++) {
      if (data[i5].type === "text") {
        ...
        try {
          ...
          if (!(e11 instanceof katex.ParseError)) {
            throw e11;
          }
